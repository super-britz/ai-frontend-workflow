...
- 不创建 Figma、API、alignment、visual verification 或 review 的细节模板；这些由 `frontend-design-breakdown`、`frontend-api-contract`、`frontend-design-api-alignment`、`frontend-visual-verification` 和 `frontend-code-review` 负责。
