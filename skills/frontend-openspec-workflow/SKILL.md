...
- `docs/design-breakdown.md`、`docs/api-contract.md`、`docs/design-api-alignment.md` 是事实文件；拆解不准时直接改这些文件。
...
| 发现的问题 | 修改位置 |
| --- | --- |
| 页面结构、组件映射、状态或视觉验收点不准 | `docs/design-breakdown.md` |
| 接口字段、类型、分页、错误码或权限不准 | `docs/api-contract.md` |
| 字段映射、adapter、差异分类不准 | `docs/design-api-alignment.md` |
...
- `docs/design-breakdown.md` 已审核。
- 涉及接口时，`docs/api-contract.md` 已审核。
- `docs/design-api-alignment.md` 已审核。
