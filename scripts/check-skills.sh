...
require_file "${ROOT_DIR}/templates/openspec/frontend/design.md"
...
grep -q 'Architecture Gate' "${ROOT_DIR}/templates/openspec/frontend/decisions.md" || fail "frontend decisions template must include Architecture Gate"
